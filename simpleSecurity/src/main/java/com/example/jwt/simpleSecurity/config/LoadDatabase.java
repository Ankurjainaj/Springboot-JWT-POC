...
//
//    @Value("${data.users:admin,usermain,user1,user2,user3,user4,user5}")
...
//                log.info("save {}", repo.save(new User(email, pwd, role, minGleePerDay, null)));
//            }
//        };
//    }
//
//    @Bean
//    CommandLineRunner initGlee(AuthLevelRepository repo, UserRepository userRepo) {
//        return args -> {
//            for (int i = 0; i < 100; i++) {
...
//                log.info("save {}", repo.save(new AuthLevel(date, time, text, value)));
//            }
//        };
//    }
//
