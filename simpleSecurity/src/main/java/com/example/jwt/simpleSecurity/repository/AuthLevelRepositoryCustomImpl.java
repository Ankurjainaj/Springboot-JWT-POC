...
public class AuthLevelRepositoryCustomImpl implements AuthLevelRepositoryCustom {
    @PersistenceContext
    private EntityManager em;

    @Override
    public Page<AuthLevel> filter(LocalDate fromDate, LocalDate toDate, LocalTime fromTime, LocalTime toTime, String text, Double value, String userId, Pageable p) {
        ...
        TypedQuery<AuthLevel> q = em.createQuery(query, AuthLevel.class);
        ...
        List<AuthLevel> list = q.getResultList();
